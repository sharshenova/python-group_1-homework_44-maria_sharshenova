...
from webapp.views import FoodListView, FoodDetailView, FoodCreateView, FoodUpdateView, FoodDeleteView, OrderListView, OrderDetailView, OrderCreateView, OrderFoodCreateView
